...
if {[is_project_open]} {
	if {[string compare $quartus(project) "LogicalStep_Lab4"]} {
		puts "Project LogicalStep_Lab4 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists LogicalStep_Lab4]} {
		project_open -revision LogicalStep_Lab4_top LogicalStep_Lab4
	} else {
		project_new -revision LogicalStep_Lab4_top LogicalStep_Lab4
	}
...
#	set_global_assignment -name STRATIX_DEVICE_IO_STANDARD "2.5 V"
	...
	set_global_assignment -name SDC_FILE LogicalStep_Lab4_top.out.sdc

	set_global_assignment -name SOURCE_FILE LogicalStep_Lab4_top.vhd
	...
	set_location_assignment PIN_43 -to pb_n[3]
	set_location_assignment PIN_44 -to pb_n[2]
	set_location_assignment PIN_45 -to pb_n[1]
	set_location_assignment PIN_46 -to pb_n[0]
	...
	set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to pb_n[3]
	set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to pb_n[2]
	set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to pb_n[1]
	set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to pb_n[0]
